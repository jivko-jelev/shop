...
{{--    <link rel="stylesheet" type="text/css" href="{{  URL::to('plugins/slick-1.8.0/slick.css') }}">--}}
...
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <button type="submit" class="header_search_button trans_300" value="Submit"><img src="images/search.png" alt="">--}}
{{--                                        </button>--}}
{{--                                    </form>--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                                                                src="{{ $product->getThumbnail(0) }}" alt=""></div>--}}
...
{{--                                        </div>--}}
{{--                                        <div class="review_text"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas fermentum laoreet.</p>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                            All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com"--}}
...
{{--<script src="{{ URL::to('plugins/slick-1.8.0/slick.js') }}"></script>--}}
                    ...
                    <div class="shop_content">
                        <div class="shop_bar clearfix">
                            <div class="shop_product_count">
                                <span>{{ $products->count() }}</span> {{ $products->count() > 1 ? 'намерени продукта' : 'намерен продукт' }}</div>
                            <div class="shop_sorting">
                                <span>Подреди по:</span>
                                <ul>
                                    <li>
                                        <span class="sorting_text">най-високо оценени<i class="fas fa-chevron-down"></i></span>
                                        <ul>
                                            <li class="shop_sorting_button" data-isotope-option='{ "sortBy": "original-order" }'>най-високо оценени</li>
                                            <li class="shop_sorting_button" data-isotope-option='{ "sortBy": "name" }'>име</li>
                                            <li class="shop_sorting_button" data-isotope-option='{ "sortBy": "price" }'>цена възх.</li>
                                            <li class="shop_sorting_button" data-isotope-option='{ "sortBy": "price" }'>цена низх.</li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 col-md-3">
                                        ...
                                        <div class="product_item is_new">
                                            ...
                                            <div class="product_content">
                                                <div class="product_price">{{ $product->name }}</div>
                                                <div class="product_name">
                ...
                <div class="col">
                    <div class="brands_slider_container">
                        ...
                        <div class="owl-carousel owl-theme brands_slider">
                            ...
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img src="{{ URL::to('images/brands_1.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img src="{{ URL::to('images/brands_2.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img src="{{ URL::to('images/brands_3.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img src="{{ URL::to('images/brands_4.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img src="{{ URL::to('images/brands_5.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img src="{{ URL::to('images/brands_6.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img src="{{ URL::to('images/brands_7.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img src="{{ URL::to('images/brands_8.jpg') }}" alt="">
                                </div>
                            </div>
...
<script>
    $('.product_item').hover(
        function () {
            ...
            $(this).find('.product_cart_button').css('visibility', 'visible');
            $(this).find('.product_cart_button').css('opacity', '1');
        },
        function () {
            $(this).find('.product_border').show();
            $(this).find('.product_cart_button').css('visibility', 'hidden');
            $(this).find('.product_cart_button').css('opacity', '0');
        });
</script>
</body>
